...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		persistentUpdate = persistentDraw = FlxG.save.data.globalAntialiasing;
		...
		txtWeekTitle.antialiasing = FlxG.save.data.globalAntialiasing;
		txtWeekTitle.alpha = 0.7;

		var rankText:FlxText = new FlxText(0, 10);
		rankText.text = 'RANK: GREAT';
		rankText.setFormat(Paths.font("comic.ttf"), 32);
		rankText.antialiasing = FlxG.save.data.globalAntialiasing;
		...
		for (i in 0...weeks.length)
		{
			...
			weekThing.targetX = i;
			weekThing.antialiasing = FlxG.save.data.globalAntialiasing;
		...
		txtTrackdeco.antialiasing = FlxG.save.data.globalAntialiasing;
		...
		txtTracklist.antialiasing = FlxG.save.data.globalAntialiasing;
